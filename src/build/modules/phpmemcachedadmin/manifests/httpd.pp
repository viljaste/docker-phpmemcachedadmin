class phpmemcachedadmin::httpd {
  ...
  file { '/etc/apache2/sites-available/default':
    ...
    source => 'puppet:///modules/phpmemcachedadmin/etc/apache2/sites-available/default',
    mode => 644
  }
  ...
  file { '/etc/apache2/sites-available/default-ssl':
    ...
    source => 'puppet:///modules/phpmemcachedadmin/etc/apache2/sites-available/default-ssl',
    mode => 644
  }
